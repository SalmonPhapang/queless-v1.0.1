...
class LightModeColors {
  ...
  static const lightPrimary = Color(0xFF111827); // Charcoal/near-black for primary CTAs
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFF3F4F6); // Subtle gray container
  ...
  static const lightTertiary = Color(0xFF10B981); // Minty green for tertiary accents
  ...
  static const lightOnSurface = Color(0xFF000000); // Black text on light background
...
class DarkModeColors {
  ...
  static const darkPrimary = Color(0xFF06C167); // Use green as primary CTA on dark
...
ThemeData get lightTheme => ThemeData(
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      backgroundColor: LightModeColors.lightPrimary, // Charcoal buttons on light mode
...
ThemeData get darkTheme => ThemeData(
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      backgroundColor: DarkModeColors.darkPrimary, // Green CTAs on dark mode
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 16),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      side: const BorderSide(color: DarkModeColors.darkOnSurface, width: 1.5),
    ),
  ),
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(
