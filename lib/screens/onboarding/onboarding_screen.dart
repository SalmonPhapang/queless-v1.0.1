...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = const [
    OnboardingPage(
      ...
      title: 'Fast Delivery',
      description:
          'Get your favorite beverages delivered to your doorstep in minutes. We bring the party to you.',
    ),
    OnboardingPage(
      icon: Icons.verified_user_outlined,
      title: 'Age Verified & Safe',
      description:
          'All orders comply with South African liquor laws. We verify age to ensure responsible delivery.',
    ),
    OnboardingPage(
      icon: Icons.shopping_bag_outlined,
      title: 'Wide Selection',
      description:
          'Browse hundreds of local and international beers, wines, spirits, and mixers all in one place.',
    ),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final minHeight =
            constraints.maxHeight > 80 ? constraints.maxHeight - 80 : 0.0;
